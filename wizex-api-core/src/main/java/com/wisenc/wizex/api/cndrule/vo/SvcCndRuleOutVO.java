...
/**
 * Class Name : SvcCndRuleOutVO.java
 * Description : 조건규칙 설정 정보. 결과(응답)정보.
 ...
 * version 1.0
 */
public class SvcCndRuleOutVO {
    private String cndRuleCd;

    private String cndRuleOutSeq;
	...
	public String getCndRuleOutSeq() {
		return cndRuleOutSeq;
	}

	public void setCndRuleOutSeq(String cndRuleOutSeq) {
		this.cndRuleOutSeq = cndRuleOutSeq;
	}
