...
<h5 style="position:absolute; top:50%; left:50%; transform:translate(-50%, -50%); display:inline-block; margin:0; font-size:1rem; color:#666;">DEMO버전에 포함되지 않은 기능입니다.</h5>
</body>
</html>
